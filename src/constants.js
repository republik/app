...
// Base urls
export const ENV = handleEnv(Settings.get('environment_preference'))
export const API_URL = handleEnv(Settings.get('graphql_url'))
export const API_WS_URL = handleEnv(Settings.get('ws_url'))
export const FRONTEND_BASE_URL = handleEnv(Settings.get('application_url'))
export const ASSETS_SERVER_BASE_URL = handleEnv(Settings.get('assets_url'))
